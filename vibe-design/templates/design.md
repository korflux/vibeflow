...
- Chat: `interview`, `spec` e `design` podem continuar no mesmo chat. Recomende novo chat para `vibe-plan`; se o humano preferir, continuar aqui não bloqueia. O `design.md` vivo é a ponte e entra no git.
