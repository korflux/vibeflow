## Visão geral
  ...
  A implementação possui dois motores e um launcher Unix. As suítes atuais passam com 22 contratos PowerShell e 7
  contratos Python, incluindo paridade essencial entre os motores.

  ## Papel de cada arquivo

  - /A:/Projetos/vibeflow/vibe-init/SKILL.md: orquestra todo o processo. Define quando executar o script, como
    interpretar o relatório, como fazer merge e quais perguntas fazer.

  - /A:/Projetos/vibeflow/vibe-init/scripts/init.ps1: implementação PowerShell do inventário, backups, reparos, scan,
    symlinks, protocolo de merge e relatório.

  - /A:/Projetos/vibeflow/vibe-init/scripts/init.py: implementação portátil em Python 3 com o mesmo contrato.

  - /A:/Projetos/vibeflow/vibe-init/scripts/init.sh: launcher Unix. Prefere Python 3 e usa PowerShell 7 como fallback.

  - /A:/Projetos/vibeflow/vibe-init/templates/REGRAS.md: template inicial da fonte viva de regras.
  - /A:/Projetos/vibeflow/docs/vibe-init/tests/test-init.ps1 e test-init.py: suítes de contrato externas ao pacote
  ...
  - legado_vs_regras: existe conteúdo legado em um ou ambos os ponteiros e também existe ou será criado REGRAS.md.
  ...
  A suíte comprova os principais cenários: repositório vazio, reparo, backup versionado, falha de hash, merge com uma ou
  duas fontes, migração de REGRAS.md da raiz, checkout Windows sem symlinks, reparo do bloco da cadeia e idempotência do
  estado saudável.
